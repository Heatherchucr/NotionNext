...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '褚容', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '褚容的作品集', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.portfoliozone.top', // 网站地址
